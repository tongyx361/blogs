...
# RL as Data Flow Graph

## Different RL Algorithms' Data Flow Graphs

Reinforcement Learning (RL) for LLM Post-Training can typically be modeled as a data flow graph, consisting of 3 stages.

![](./assets/rl-dataflow-examples.png){.lightbox}

# Implementing Data Flow Graph as Execution Pattern

In practice, we should implement the data flow graph with device placement,
...
If you find these slides useful, please kindly cite us as follows:
...
@online{tong2025kl,
  ...
  title = {verl Tutorial},
  year = {2025},
  url = {https://tongyx361.github.io/slides/verl-tutorial},
  urldate = {2025-04-22},
  language = {English},
}
```
