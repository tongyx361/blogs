...
## Contraints: Data Dependencies & Resource Limitations
...
- Programmming interface based on the **"single-controller"** paradigm
...
## Async Engine for Multi-Turn Rollout (Upstreamed) {.smaller}
...
- Synchronous Engine: returns all the outputs at the same time
...
1. Extensible **tool** interfaces (`BaseTool`)
2. **Multi-Model** LLMs' RL
3. Full support for [RL with **AMD (ROCm Kernel)** hardwares](https://github.com/volcengine/verl?tab=readme-ov-file#hardware-support-amd-rocm-kernel)
4. Optimizations: Gradient Checkpointing, Torch Compile, Liger Kernel, etc.
5. ...
