---
# title
title: '[WIP] Justifying Importance Sampling with Sliding Latest Policy Trajectories'
date: "2026-01-07"
author: 
  - name: "Yuxuan Tong"
...
# IS with Sliding Latest Policy Trajectories

Despite Partial Rollout's efficiency and simplicity, there have been worries about applying IS with SLAPTs, since most previous distributed RL works including the most representative IMPALA [@espeholt2018impala] formulate IS with a single consistent behavior policy $\mu(a \mid s)$, and it feels weird to mix multiple policies $\pi_{\theta_{n}},\ldots,\pi_{\theta_{n+m}},\ldots,\pi_{\theta_{n+M}}$ within a single trajectory.
