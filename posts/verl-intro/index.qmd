...
1. **Multi-Modal**: Qwen2.5-VL, Kimi-VL, etc.
2. **Multi-Turn & Tool Using**: see progress at [#1882](https://github.com/volcengine/verl/issues/1882) 
3. ...
...
## Efficient RL with Huge MoE like DeepSeek-V3-671B (V0.4+)

verl supports efficient RL training for **huge MoE like DeepSeek-V3-671B**, based on the following features:

1. Training: **MoE models classes** supporting diverse parallelism strategies like Expert Parallelism based on Megatron `GPTModel`
2. Inference: **Multi-node** inference
3. Hybrid: **Parameter sharding manager** for Megatron-Core V0.12 + latest inference engines

## 2025 Q3 Focuses

1. MFU Optimization of huge MoE model training
2. More flexible RL architecture enabling different levels of asynchrony
3. Agent recipes
...
❓ Further Questions @ [tongyuxuan361@bytedance.com](mailto:tongyuxuan361@bytedance.com)
